...
Note to future Pokébolts: this code can be used for reference, but you are advised against copying it verbatim. This was our team's first try at command based programming, so it's not the most streamlined. :)
